...
@pytest.fixture
def initial_position(motion_controller, alias):
...
def test_set_homing_mode(motion_controller, alias, homing_mode):
    mc = motion_controller
...
def test_set_homing_offset(motion_controller, alias, homing_offset):
    mc = motion_controller
...
def test_set_homing_timeout(motion_controller, alias, homing_timeout):
    mc = motion_controller
...
def test_homing_on_current_position(motion_controller, alias, homing_offset):
    mc = motion_controller
...
def test_homing_on_switch_limit(motion_controller, alias, direction):
    mc = motion_controller
    homing_offset = 10
    homing_timeout = 5000
    search_vel = 10.0
...
@pytest.mark.canopen
@pytest.mark.usefixtures("initial_position")
def test_homing_on_switch_limit_timeout(motion_controller, alias):
    mc = motion_controller
    homing_offset = 10
    homing_timeout = 5000
    search_vel = 10.0
...
@pytest.mark.usefixtures("initial_position")
@pytest.mark.parametrize("direction", [1, 0])
def test_homing_on_index_pulse(motion_controller, alias, feedback_list, direction):
    mc = motion_controller
    homing_offset = 1000
...
@pytest.mark.usefixtures("initial_position")
@pytest.mark.parametrize("direction", [1, 0])
def test_homing_on_switch_limit_and_index_pulse(motion_controller, alias, direction):
    mc = motion_controller
    homing_offset = 300
    homing_timeout = 3000
    search_vel = 5.0
