...
@pytest.fixture
def teardown_brake_override(motion_controller, alias):
    yield
...
def test_release_brake(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.smoke
@pytest.mark.usefixtures("teardown_brake_override")
def test_enable_brake(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.smoke
@pytest.mark.usefixtures("teardown_brake_override")
def test_disable_brake_override(motion_controller, alias):
    mc = motion_controller
...
def test_save_configuration_and_load_configuration(motion_controller, alias):
    file_path = "test_file.xcf"
    mc = motion_controller
...
@pytest.mark.ethernet
@pytest.mark.smoke
def test_save_configuration_and_load_configuration_nvm_none(motion_controller, alias):
    file_path = "test_file.xcf"
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_set_profiler_exception(motion_controller, alias):
    mc = motion_controller
...
def test_set_profiler(motion_controller, alias, acceleration, deceleration, velocity):
    mc = motion_controller
    register_dict = {
...
def test_set_max_profile_acceleration(motion_controller, alias, acceleration):
    mc = motion_controller
...
def test_set_max_deceleration(motion_controller, alias, deceleration):
    mc = motion_controller
...
def test_set_max_velocity(motion_controller, alias, velocity):
    mc = motion_controller
...
@pytest.mark.smoke
@pytest.mark.parametrize("velocity", [0, 10, 25])
def test_set_max_profile_velocity(motion_controller, alias, velocity):
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_position_and_velocity_loop_rate(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_current_loop_rate(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_power_stage_frequency(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_power_stage_frequency_raw(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_power_stage_frequency_enum(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_power_stage_frequency_exception(mocker, motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_status_word(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.canopen
@pytest.mark.smoke
def test_is_motor_enabled_1(motion_controller, alias):
    mc = motion_controller
...
def test_is_motor_enabled_2(mocker, motion_controller, alias, status_word_value, expected_result):
    mc = motion_controller
    mocker.patch(
...
def test_is_commutation_feedback_aligned(
    mocker, motion_controller, alias, status_word_value, expected_result
):
    mc = motion_controller
    mocker.patch(
        "ingeniamotion.configuration.Configuration.get_status_word", return_value=status_word_value
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_set_phasing_mode(motion_controller, alias):
    input_value = 0
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_phasing_mode(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_set_generator_mode(motion_controller, alias):
    input_value = 0
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_motor_pair_poles(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_sto_status(motion_controller, alias):
    mc = motion_controller
...
def test_is_sto1_active(mocker, motion_controller, alias, sto_status_value, expected_result):
    mc = motion_controller
...
def test_is_sto2_active(mocker, motion_controller, alias, sto_status_value, expected_result):
    mc = motion_controller
    patch_get_sto_status(mocker, sto_status_value)
...
def test_check_sto_power_supply(
    mocker, motion_controller, alias, sto_status_value, expected_result
):
    mc = motion_controller
    patch_get_sto_status(mocker, sto_status_value)
...
def test_is_sto_abnormal_fault(mocker, motion_controller, alias, sto_status_value, expected_result):
    mc = motion_controller
    patch_get_sto_status(mocker, sto_status_value)
...
def test_get_sto_report_bit(mocker, motion_controller, alias, sto_status_value, expected_result):
    mc = motion_controller
    patch_get_sto_status(mocker, sto_status_value)
...
def test_is_sto_active(mocker, motion_controller, alias, sto_status_value, expected_result):
    mc = motion_controller
    patch_get_sto_status(mocker, sto_status_value)
...
def test_is_sto_inactive(mocker, motion_controller, alias, sto_status_value, expected_result):
    mc = motion_controller
    patch_get_sto_status(mocker, sto_status_value)
...
def test_is_sto_abnormal_latched(
    mocker, motion_controller, alias, sto_status_value, expected_result
):
    """
...
@pytest.mark.canopen
@pytest.mark.smoke
def test_store_configuration(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.canopen
@pytest.mark.smoke
def test_restore_configuration(motion_controller, alias):
    mc = motion_controller
    mc.configuration.restore_configuration(servo=alias)


@pytest.mark.virtual
def test_get_drive_info_coco_moco(motion_controller, alias):
...
@pytest.mark.virtual
def test_get_product_code(motion_controller, alias):
...
@pytest.mark.virtual
def test_get_revision_number(motion_controller, alias):
...
@pytest.mark.virtual
def test_get_serial_number(motion_controller, alias):
...
@pytest.mark.virtual
def test_get_fw_version(motion_controller, alias):
...
@pytest.mark.virtual
def test_change_baudrate_exception(motion_controller, alias):
    mc = motion_controller
    with pytest.raises(ValueError):
...
@pytest.mark.virtual
def test_get_vendor_id(motion_controller, alias):
...
@pytest.mark.virtual
def test_change_node_id_exception(motion_controller, alias):
    mc = motion_controller
    with pytest.raises(ValueError):
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_set_rated_current(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_get_max_current(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
def test_set_commutation_mode(motion_controller, alias):
...
@pytest.mark.virtual
def test_get_commutation_mode(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
def test_get_bus_voltage(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
def test_set_pos_to_vel_ratio(motion_controller, alias):
    input_value = 1.0
    mc = motion_controller
...
@pytest.mark.virtual
def test_get_pos_to_vel_ratio(motion_controller, alias):
    mc = motion_controller
...
def test_configure_filter(motion_controller, alias, filter_type, filter_number, filter_signal):
    mc = motion_controller
    frequency = 10
    q_factor = 1.3
    gain = 1.2
...
@pytest.mark.virtual
def test_load_configuration_file_not_found(motion_controller, alias):
    file_path = "test_file.xcf"
    mc = motion_controller
...
@pytest.mark.virtual
def test_wrong_type_exception(mocker, motion_controller, alias, function, wrong_value):
    mc = motion_controller
...
@pytest.mark.virtual
def test_get_phasing_mode_invalid(mocker, motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
def test_change_tcp_ip_parameters_exception(mocker, motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
def test_store_restore_tcp_ip_parameters_exception(mocker, motion_controller, alias, function):
    mc = motion_controller
    mocker.patch.object(mc, "_get_drive", return_value=EthercatServo)
    with pytest.raises(IMError):
        getattr(mc.configuration, function)(servo=alias)
...
@pytest.mark.virtual
def test_get_subnode_type(motion_controller, alias, subnode, expected_result):
    mc = motion_controller
    assert mc.configuration.get_subnode_type(subnode) == expected_result


@pytest.mark.virtual
def test_get_subnode_type_exception(motion_controller, alias):
    mc = motion_controller
    with pytest.raises(ValueError):
