...
def test_create_monitoring_no_trigger(motion_controller, alias):
...
@pytest.mark.usefixtures("skip_if_monitoring_not_available")
@pytest.mark.usefixtures("disable_monitoring_disturbance")
def test_create_disturbance(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
@pytest.mark.smoke
def test_mcb_synchronization(mocker, motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.canopen
@pytest.mark.smoke
def test_mcb_synchronization_fail(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.smoke
@pytest.mark.usefixtures("skip_if_monitoring_not_available")
def test_disturbance_max_sample_size(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.usefixtures("disable_monitoring_disturbance")
@pytest.mark.usefixtures("skip_if_monitoring_not_available")
def test_get_frequency(motion_controller, alias):
    mc = motion_controller
    registers = [{"name": "CL_POS_REF_VALUE", "axis": 1}]
    max_frequency = mc.configuration.get_position_and_velocity_loop_rate(alias)
    divider = 40
...
@pytest.mark.virtual
def test_create_poller_exceptions(motion_controller, alias, name, axis):
...
@pytest.mark.virtual
def test_create_empty_monitoring_exception(mocker, motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
def test_check_monitoring_version_v3(motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
def test_check_monitoring_version_v2(mocker, motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
def test_check_monitoring_version_v1(mocker, motion_controller, alias):
    mc = motion_controller
    mocker.patch.object(mc.capture, "MONITORING_VERSION_REGISTER", return_value="NON_EXISTING_UID")
    mocker.patch.object(
...
@pytest.mark.virtual
def test_check_monitoring_version_not_available(mocker, motion_controller, alias):
    mc = motion_controller
    mocker.patch.object(mc.capture, "MONITORING_VERSION_REGISTER", return_value="NON_EXISTING_UID")
    mocker.patch.object(
        mc.capture, "MONITORING_CURRENT_NUMBER_BYTES_REGISTER", return_value="NON_EXISTING_UID"
...
@pytest.mark.virtual
def test_enable_monitoring_exception(mocker, motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
def test_enable_disturbance_exception(mocker, motion_controller, alias):
    mc = motion_controller
...
@pytest.mark.virtual
def test_get_monitoring_disturbance_status_exception(mocker, motion_controller, alias, function):
    mc = motion_controller
...
@pytest.mark.virtual
def test_get_monitoring_process_stage_v3(
    mocker, motion_controller, alias, monitor_status, expected_stage
):
    mc = motion_controller
...
def test_get_monitoring_process_stage_v1_v2(
    mocker, motion_controller, alias, monitoring_status, expected_stage
):
    mc = motion_controller
...
@pytest.mark.virtual
def test_is_frame_available(
    mocker, motion_controller, alias, monitoring_status, monitoring_version
):
    mc = motion_controller
    mocker.patch.object(mc.capture, "get_monitoring_status", return_value=monitoring_status)
...
@pytest.mark.virtual
def test_monitoring_disturbance_max_sample_size_exception(
    mocker, motion_controller, alias, function
):
    mc = motion_controller
    mocker.patch.object(mc.communication, "get_register", return_value="invalid_value")
    with pytest.raises(TypeError):
...
@pytest.mark.virtual
def test_get_frequency_exception(mocker, motion_controller, alias):
    mc = motion_controller
    mocker.patch.object(mc.communication, "get_register", return_value="invalid_value")
    with pytest.raises(TypeError):
