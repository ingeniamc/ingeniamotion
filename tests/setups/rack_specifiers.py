...
ECAT_DEN_S_PHASE2_SETUP = RackServiceConfigSpecifier.from_firmware(
    ...
    config_file=None,
    firmware=Path(
        "//azr-srv-ingfs1/dist/products/i050_summit/i056_den-s-net-e/release_candidate/2.9.0.7/den-s-net-e_2.9.0.lfu"
    ),
    dictionary=Path(
        "//azr-srv-ingfs1/dist/products/i050_summit/i056_den-s-net-e/release_candidate/2.9.0.7/den-s-net-e_2.9.0.007_v3.xdf"
    ),
)
