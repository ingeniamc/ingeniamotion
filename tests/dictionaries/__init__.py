...
VIRTUAL_DRIVE_XDF_PATH = (__dictionaries_root_path / "virtual_drive_custom_dict.xdf").as_posix()
...
SDCP_EXAMPLE_DICT = (__dictionaries_root_path / "sdcp_example.xdf3").as_posix()
