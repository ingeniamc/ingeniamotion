...
def establish_canopen_communication(mc: MotionController, device: CAN_DEVICE, channel: int, node_id: int, baudrate: CAN_BAUDRATE, dictionary_path: str) -> None:
...
def change_node_id(device: CAN_DEVICE, channel: int, node_id: int, baudrate: CAN_BAUDRATE, dictionary_path: str, new_node_id: int) -> None:
    mc = MotionController()
    try:
        establish_canopen_communication(mc, device, channel, node_id, baudrate, dictionary_path)
...
if __name__ == "__main__":
    ...
    change_node_id(device, channel, node_id, baudrate, dictionary_path, 20)
