...
class MonitoringV1(Monitoring):
    ...
    def __get_old_soc_type(self, edge_condition):
        ...
        raise NotImplementedError("Edge condition is not implemented"
                                  "for this FW version")
    ...
    def set_trigger(self, trigger_mode, edge_condition=None,
        ...
        self.mc.communication.set_register(
            ...
            trigger_mode, servo=self.servo, axis=0)
    ...
    def __rising_or_falling_edge_trigger(self, edge_condition, index_reg, level_edge):
        ...
        self.mc.communication.set_register(
            self.EDGE_CONDITION_REGISTER[edge_condition],
            level_edge,
            servo=self.servo,
            axis=0
        )
