...
class DriveTests(metaclass=MCMetaClass):
    __sensors = {
        SensorType.ABS1: AbsoluteEncoder2Test,
    ...
    def digital_halls_test(self, servo=DEFAULT_SERVO, axis=DEFAULT_AXIS, apply_changes=True):
    ...
    def incremental_encoder_1_test(
        self, servo=DEFAULT_SERVO, axis=DEFAULT_AXIS, apply_changes=True
    ):
    ...
    def absolute_encoder_1_test(self, servo=DEFAULT_SERVO, axis=DEFAULT_AXIS, apply_changes=True):
    ...
    def absolute_encoder_2_test(self, servo=DEFAULT_SERVO, axis=DEFAULT_AXIS, apply_changes=True):
    ...
    def secondary_ssi_test(self, servo=DEFAULT_SERVO, axis=DEFAULT_AXIS, apply_changes=True):
    ...
    def __feedback_test(self, feedback, servo=DEFAULT_SERVO, axis=DEFAULT_AXIS, apply_changes=True):
    ...
    def commutation(self, servo=DEFAULT_SERVO, axis=DEFAULT_AXIS, apply_changes=True):
